...
MODULE radial_grids
  !============================================================================
  !
  !   Module containing type definitions and auxiliary routines deal with
  !   data on logarithmic radial grids.
  !   Should contain low level routines and no reference to otehr modules
  ...
  !
  integer, parameter :: &
       ndmx=2000     ! the maximum mesh size 
...
END TYPE radial_grid_type
  ...
  PRIVATE
  PUBLIC :: radial_grid_type, ndmx, hartree, series
